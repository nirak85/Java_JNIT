<%@ page import="java.sql.*" %>
	 ...
	 <%
		...
		PreparedStatement ps= con.prepareStatement("insert into patient_appointment(username, email, phone, specialist, appointment_date, appointment_time, pid) values(?,?,?,?,?,?,?)");
		ps.setString(1,user);
